...
JSON_DEST_DIR = '/scratch/scratch6/gopi/gopi/CreatingDataset/ImagenetteDataset_val/JsonFiles'
...
ORIGINAL_GRADCAM_HEATMAPS_DIR = '/scratch/scratch6/gopi/gopi/CreatingDataset/ImagenetteDataset_val/Heatmaps/GradCAM_Heatmaps/Original_Heatmaps'
...
GRADCAM_ADVERSARIAL_HEATMAPS_FGSM = '/scratch/scratch6/gopi/gopi/CreatingDataset/ImagenetteDataset_val/Heatmaps/GradCAM_Heatmaps/Adversarial_Heatmaps/Adversarial_Heatmaps_FGSM'
GRADCAM_ADVERSARIAL_HEATMAPS_PGD = '/scratch/scratch6/gopi/gopi/CreatingDataset/ImagenetteDataset_val/Heatmaps/GradCAM_Heatmaps/Adversarial_Heatmaps/Adversarial_Heatmaps_PGD'

ABLATIONCAM_ADVERSARIAL_HEATMAPS_FGSM = '/scratch/scratch6/gopi/gopi/CreatingDataset/ImagenetteDataset_val/Heatmaps/AblationCAM_Heatmaps/Adversarial_Heatmaps/Adversarial_Heatmaps_FGSM'
ABLATIONCAM_ADVERSARIAL_HEATMAPS_PGD = '/scratch/scratch6/gopi/gopi/CreatingDataset/ImagenetteDataset_val/Heatmaps/AblationCAM_Heatmaps/Adversarial_Heatmaps/Adversarial_Heatmaps_PGD'
...
if __name__ == '__main__':
    ...
    for idx, each_input_image in enumerate(all_files_list):
        ...
        gc_heatmap_path = f"{ORIGINAL_GRADCAM_HEATMAPS_DIR}/{tail}"
        ...
        # ac_heatmap_path = f"{ORIGINAL_ABLATIONCAM_HEATMAPS_DIR}/{tail}"
    ...
    fgsm_pgd_gc_dest_dirs = [GRADCAM_ADVERSARIAL_HEATMAPS_FGSM, GRADCAM_ADVERSARIAL_HEATMAPS_PGD]
    fgsm_pgd_ac_dest_dirs = [ABLATIONCAM_ADVERSARIAL_HEATMAPS_FGSM, ABLATIONCAM_ADVERSARIAL_HEATMAPS_PGD]
