...
IMAGENETTE_DIR_PATH = '/scratch/scratch6/gopi/gopi/imagenette2-320/train'
...
TRAIN_PERTURBATIONS_DIR = '/scratch/scratch6/gopi/gopi/CreatingDataset/ImagenetteDataset_train/PerturbationsPGD'
TRAIN_ADVERSARIAL_DIR = '/scratch/scratch6/gopi/gopi/CreatingDataset/ImagenetteDataset_train/AdversarialPGD'
...
def build_folders():
	paths_list = [TRAIN_PERTURBATIONS_DIR, TRAIN_ADVERSARIAL_DIR]
	...
	for eps in EPS_LIST:
		...
		for idx, each_input_image in enumerate(all_files_list):
			...
			for epochs in EPOCHS_LIST:
				...
				result_perturbations_dir = TRAIN_PERTURBATIONS_DIR + f"/for_{eps}_{epochs}"
				save_image(perturbations_per_epochs[i], f"perturbations_{tail}", result_perturbations_dir)

				result_adversarial_dir = TRAIN_ADVERSARIAL_DIR + f"/for_{eps}_{epochs}"
